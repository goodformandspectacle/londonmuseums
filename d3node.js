     ...
     "http://d3js.org/d3.geo.tile.v0.min.js"], function (err, window) {
        ...
        svg.selectAll("g")
            ...
            .each(function(d) {
                ...
                window.d3.json("http://" + ["a", "b", "c"][(d[0] * 31 + d[1]) % 3] + ".tile.openstreetmap.us/vectiles-highroad/" + d[2] + "/" + d[0] + "/" + d[1] + ".json", function(error, json) {
                    g.selectAll("path")
        ...
        svg.selectAll(".waypath").data([waypath])
            .enter().append("path")
            .attr("class","waypath")
             .attr("style","fill: none; stroke: orange; stroke-width: 5; }")
            .attr("d",path);
